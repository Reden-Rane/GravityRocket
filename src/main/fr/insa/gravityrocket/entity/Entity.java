...
import fr.insa.gravityrocket.CollisionBox;
import fr.insa.gravityrocket.RectangularCollisionBox;
...
public abstract class Entity
{
    ...
    public double squaredDistance(Entity entity) {
        return (entity.xPos - this.xPos) * (entity.yPos - this.yPos) + (entity.yPos - this.yPos) * (entity.yPos - this.yPos);
    }
