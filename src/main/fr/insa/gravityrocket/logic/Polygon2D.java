...
public class Polygon2D implements Shape, Cloneable, Serializable
{
    ...
    /**
     * The array of <i>x</i> coordinates. The value of {@link #npoints npoints} is equal to the number of points in
     * this
     * <code>Polygon2D</code>.
     */
     ...
     * @throws IndexOutOfBoundsException  if <code>npoints</code> is greater than the length of <code>xpoints</code> or
     ...
     * are returned by the iterator. Since polygons are already flat, the <code>flatness</code> parameter is ignored.
     *
     ...
     *                 subdivided curve is replaced by a straight line connecting the endpoints.  Since polygons are
     *                 already flat the
